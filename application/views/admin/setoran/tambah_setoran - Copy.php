      ...
      <div class="box-body">
             ...
             <div class="col-sm-6">
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="saldolama" class="form-control" id="saldolama" placeholder="Saldo" readonly required="">
                  </div>
                </div>
             </div>
              <div class="box-body"></div>
    ...
    <table id="example1" class="display nowrap" style="width:50%">
      ...
      ?>
             ...
             <script type="text/javascript">
                        ...
                        <?php } ?>
                        var saldo = parseInt(document.getElementById('saldolama').value) + parseInt(document.getElementById('jumlah_setor').value);
